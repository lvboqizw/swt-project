...
public class Application {
	...
	@Configuration
	static class ComputechWebConfiguration implements WebMvcConfigurer {
	...
	/**
	 * JavaMailSender SetUp Protocoll
	...
	public JavaMailSender getJavaMailSender() {
		...
		mailSender.setUsername("swtproject2020@gmail.com");
		mailSender.setPassword("swtProject");
